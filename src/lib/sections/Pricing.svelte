...
<section class="bg-neutral-50 dark:bg-dark">
	...
	>
		<div
			class="flex flex-col items-center px-6 py-8 shadow-md dark:shadow-neutral-600 rounded-lg bg-white dark:bg-neutral-800"
		>
			<div class="text-neutral-500 mb-2">
				<Icon class="w-12 h-12" icon="material-symbols:app-shortcut" />
			</div>
			<p class="text-xl font-semibold text-neutral-700 dark:text-neutral-100 tracking-wider">
				ESTÁNDAR
			</p>
			<p class="text-4xl font-bold my-4 text-green-700 dark:text-green-500">0 Bs.</p>
			<div class="self-start">
				<ul class="list-disc ml-4">
					<li>Administración de estudiantes y materias</li>
		...
		<div
			class="flex flex-col items-center px-6 py-8 shadow-md dark:shadow-neutral-600 rounded-lg bg-white dark:bg-neutral-800"
		>
			<div class="text-yellow-400 dark:text-yellow-300 mb-2">
				<Icon class="w-12 h-12" icon="ic:round-star" />
			</div>
			<p class="text-xl font-semibold text-neutral-700 dark:text-neutral-100 tracking-wider">
				PREMIUM
			</p>
			<p class="text-4xl font-bold my-4 text-neutral-400 dark:text-neutral-500 line-through">
				150 Bs.
			</p>
			<p
				class="text-4xl font-bold text-green-700 dark:text-green-500 leading-3 -translate-x-3 animate-bounce ease-out"
			>
				100 Bs.
			</p>
